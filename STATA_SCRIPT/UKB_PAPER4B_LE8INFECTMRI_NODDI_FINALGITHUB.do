cd "E:\UK_BIOBANK_PROJECT\UKB_PAPER4B_LE8INFECTMRI_NODDI\DATA"


capture log close
capture log using "E:\UK_BIOBANK_PROJECT\UKB_PAPER4B_LE8INFECTMRI_NODDI\OUTPUT\DATA_MANAGEMENT.smcl"
...
save "E:\UK_BIOBANK_PROJECT\UKB_PAPER4B_LE8INFECTMRI_NODDI\DATA\SMALLERDATASETUKB_SECOND100K.dta", replace
...
save "E:\UK_BIOBANK_PROJECT\UKB_PAPER4B_LE8INFECTMRI_NODDI\DATA\SMALLERDATASETUKB_THIRD100K.dta", replace
...
save "E:\UK_BIOBANK_PROJECT\UKB_PAPER4B_LE8INFECTMRI_NODDI\DATA\SMALLERDATASETUKB_FOURTH100K.dta", replace
...
save "E:\UK_BIOBANK_PROJECT\UKB_PAPER4B_LE8INFECTMRI_NODDI\DATA\SMALLERDATASETUKB_FIFTH100K.dta", replace
...
capture log close
capture log using "E:\UK_BIOBANK_PROJECT\UKB_PAPER4B_LE8INFECTMRI_NODDI\OUTPUT\DATA_MANAGEMENT2.smcl"
...
****************************STEP 7: MERGE FILES TOGETHER FOR LIFE'S ESSENTIAL 8****************************
...
//STEP 8: GENERATE LIFE'S ESSENTIAL 8 INDEX//////
...
//STEP 8: GENERATE COGNITION VARIABLES//
...
//STEP 9: GENERATE AD/DEMENTIA AND RELATED TIME VARIABLES//
...
//STEP 10: MERGE DATASETS TOGETHER//
...
//STEP 9: H. PYLORI AND OTHER PERSISTENT INFECTIONS///////
...
capture log close
capture log using "E:\UK_BIOBANK_PROJECT\UKB_PAPER4B_LE8INFECTMRI_NODDI\OUTPUT\DATA_MANAGEMENT3.smcl", replace


////////////////////////////STEP 8: GENERATE INFECTBURDEN_UKB VARIABLES*************
...
capture log close
capture log using "E:\UK_BIOBANK_PROJECT\UKB_PAPER4B_LE8INFECTMRI_NODDI\OUTPUT\DATA_MANAGEMENT4.smcl"


/////////////////////////////////////////STEP 11: LIFE'S ESSENTIAL 8//////////////////////////////////////////////////////
...
////////////////STEP 14: AD AND OTHER STANDARD PGS////////////////////////
...
//////////////////////////STEP 15: MERGE WITH THE OTHER VARIABLES/////////////
...
save UKB_PAPER4B_LE8INFECTMRI_NODDI, replace


capture log close
capture log using "E:\UK_BIOBANK_PROJECT\UKB_PAPER4B_LE8INFECTMRI_NODDI\OUTPUT\FIGURE1.smcl"
...
gen sample2=.
replace sample2=1 if ICV~=. & TOTALBRAIN~=. & WMH~=. & Hippocampus_Left~=. & FA_mean~=. & MD_mean~=. & ISOVF_mean~=. & ICVF_mean~=. & OD_mean~=.
...
foreach x4 of varlist ISOVF_* {
	egen z`x4'=std(`x4') if sample_final==1
}


capture drop zICVF_*
foreach x5 of varlist ICVF_* {
	egen z`x5'=std(`x5') if sample_final==1
}


capture drop zOD_*
foreach x6 of varlist OD_* {
	egen z`x6'=std(`x6') if sample_final==1
}
...
capture log close
capture log using "E:\UK_BIOBANK_PROJECT\UKB_PAPER4B_LE8INFECTMRI_NODDI\OUTPUT\IMPUTATIONS.smcl"


//STEP 17: RUN MULTIPLE IMPUTATIONS///
...
//STEP 17: DO REMAINING DATA MANAGEMENT AFTER IMPUTATION: mi passive etc. ////
...
capture log close
capture log using "E:\UK_BIOBANK_PROJECT\UKB_PAPER4B_LE8INFECTMRI_NODDI\OUTPUT\TABLE1.smcl"
...
foreach x2 of varlist AGE householdsize  townsend FA_mean MD_mean ISOVF_mean ICVF_mean OD_mean  infectionburden infectionburdenhosp  TOTALBRAIN ICV WM GM LnWMHpctICV FRONTAL_GM_LEFT FRONTAL_GM_RIGHT Accumbens_Left Accumbens_Right Amygdala_Left Amygdala_Right Caudate_Left Caudate_Right Hippocampus_Left Hippocampus_Right Pallidum_Left Pallidum_Right Putamen_Left Putamen_Right Thalamus_Left Thalamus_Right AD_PGS LE8_TOTALSCORE LE8_BIOLOGICAL LE8_LIFESTYLE TIME_V0V2 AD_PGS {
...
capture log close
capture log using "E:\UK_BIOBANK_PROJECT\UKB_PAPER4B_LE8INFECTMRI_NODDI\OUTPUT\TABLE2.smcl"


*********************************************TABLE 2: INFECTION BURDEN VS. FA/MD, OVERALL AND BY LE8 TOTAL SCORE TERTILE***********************************************************************
...
foreach y1 of varlist ISOVF_mean ICVF_mean OD_mean {
...
capture log close
capture log using "E:\UK_BIOBANK_PROJECT\UKB_PAPER4B_LE8INFECTMRI_NODDI\OUTPUT\TABLE2_ANALYSISB.smcl"
...
foreach Y of var ISOVF_mean ICVF_mean OD_mean  {
...
capture log close
capture log using "E:\UK_BIOBANK_PROJECT\UKB_PAPER4B_LE8INFECTMRI_NODDI\OUTPUT\TABLES6_ANALYSISBprime.smcl"
...
global modseq=0
foreach X of var infectionburdentert {
foreach Y of var zISOVF_* zICVF_* zOD_* {
global modseq=$modseq+1
tempfile tfcur
parmby "regr `Y' `X'  AGE SEX  NonWhite AD_PGS householdsize TIME_V0V2  invmillsMRIINF if sample_final==1, beta", label command format(estimate min95 max95 %8.2f p %8.1e) idn($modseq) saving(`"`tfcur'"', replace) flist(tflist)
 }
...
capture log close
capture log using "E:\UK_BIOBANK_PROJECT\UKB_PAPER4B_LE8INFECTMRI_NODDI\OUTPUT\TABLE3.smcl"


*********************************************TABLE 3: INFECTION BURDEN VS. NODDI MEASURES,  BY AD PGS TERTILE***********************************************************************
...
**Main effect modifier: AD_PGStert 
...
foreach y1 of varlist ISOVF_mean ICVF_mean OD_mean {
mi estimate:reg `y1' c.infectionburdentert AGE SEX  i.RACE_ETHN householdsize TIME_V0V2 i.educationbr townsend i.householdincome  LE8_TOTALSCORE invmillsMRIINF if sample_final==1 & AD_PGStert==1
}



************AD PGS SECOND TERTILE**********************


foreach y1 of varlist ISOVF_mean ICVF_mean OD_mean {
mi estimate:reg `y1' c.infectionburdentert AGE SEX  i.RACE_ETHN householdsize TIME_V0V2 i.educationbr townsend i.householdincome  LE8_TOTALSCORE invmillsMRIINF if sample_final==1 & AD_PGStert==2
}



************AD PGS THIRD TERTILE**********************



foreach y1 of varlist ISOVF_mean ICVF_mean OD_mean {
mi estimate:reg `y1' c.infectionburdentert AGE SEX  i.RACE_ETHN householdsize TIME_V0V2 i.educationbr townsend i.householdincome  LE8_TOTALSCORE invmillsMRIINF if sample_final==1 & AD_PGStert==3
}
...
foreach y1 of varlist ISOVF_mean ICVF_mean OD_mean {
mi estimate:reg `y1' c.infectionburdentert##AD_PGStert AGE SEX  i.RACE_ETHN householdsize TIME_V0V2 i.educationbr townsend i.householdincome  LE8_TOTALSCORE invmillsMRIINF if sample_final==1 
}
...
capture log close
capture log using "E:\UK_BIOBANK_PROJECT\UKB_PAPER4B_LE8INFECTMRI_NODDI\OUTPUT\TABLES2.smcl"


*********************************************TABLE S2: INFECTION BURDEN VS. FA/MD, OVERALL AND BY LE8 TOTAL SCORE TERTILE***********************************************************************
...
capture log close
capture log using "E:\UK_BIOBANK_PROJECT\UKB_PAPER4B_LE8INFECTMRI_NODDI\OUTPUT\TABLES3.smcl"


*********************************************TABLE S3: INFECTION BURDEN VS. NODDI MEASURES,  BY AD PGS TERTILE***********************************************************************
...
foreach y1 of varlist ISOVF_mean ICVF_mean OD_mean {
mi estimate:reg `y1' c.infectionburdenhosptert AGE SEX  i.RACE_ETHN householdsize TIME_V0V2 i.educationbr townsend i.householdincome  LE8_TOTALSCORE invmillsMRIINF if sample_final==1 & AD_PGStert==1
}
...
foreach y1 of varlist ISOVF_mean ICVF_mean OD_mean {
mi estimate:reg `y1' c.infectionburdenhosptert AGE SEX  i.RACE_ETHN householdsize TIME_V0V2 i.educationbr townsend i.householdincome  LE8_TOTALSCORE invmillsMRIINF if sample_final==1 & AD_PGStert==2
}
...
foreach y1 of varlist ISOVF_mean ICVF_mean OD_mean {
mi estimate:reg `y1' c.infectionburdenhosptert AGE SEX  i.RACE_ETHN householdsize TIME_V0V2 i.educationbr townsend i.householdincome  LE8_TOTALSCORE invmillsMRIINF if sample_final==1 & AD_PGStert==3
}
...
foreach y1 of varlist ISOVF_mean ICVF_mean OD_mean {
mi estimate:reg `y1' c.infectionburdenhosptert##AD_PGStert AGE SEX  i.RACE_ETHN householdsize TIME_V0V2 i.educationbr townsend i.householdincome  LE8_TOTALSCORE invmillsMRIINF if sample_final==1 
}
...
capture log close
capture log using "E:\UK_BIOBANK_PROJECT\UKB_PAPER4B_LE8INFECTMRI_NODDI\OUTPUT\TERTILE_DESC.smcl"
...
capture log close
capture log using "E:\UK_BIOBANK_PROJECT\UKB_PAPER4B_LE8INFECTMRI_NODDI\OUTPUT\DETAILED_INFECTIONS.smcl"
...
capture log using "E:\UK_BIOBANK_PROJECT\UKB_PAPER4B_LE8INFECTMRI_NODDI\OUTPUT\FIGURES3_4.smcl"

*************************TRACT-SPECIFIC NODDI MEASURES BY LE8 and AD PRS TERTILE: TOTAL AND HOSPITAL TREATED INFECTION******************************



**ANALYSIS Bprime BY AD PRS: **
...
global tflist ""
global modseq=0
foreach X of var infectionburdentert infectionburdenhosptert {
foreach Y of var zISOVF_* zICVF_* zOD_* {
foreach Z of var LE8_TOTALSCOREtert {
global modseq=$modseq+1
tempfile tfcur
parmby "regr `Y' `X'  AGE SEX  NonWhite AD_PGS householdsize TIME_V0V2  invmillsMRIINF if sample_final==1, beta", by(`Z') label command format(estimate min95 max95 %8.2f p %8.1e) idn($modseq) saving(`"`tfcur'"', replace) flist(tflist)
 }
 }
 }
...
save Outputdata_overall_Cprime, replace

**Smile plot**
use Outputdata_overall_Cprime, clear
...
global modseq=$modseq+1
tempfile tfcur
parmby "regr `Y' `X'  AGE SEX  NonWhite householdsize TIME_V0V2 LE8_TOTALSCORE invmillsMRIINF if sample_final==1, beta", by(`Z') label command format(estimate min95 max95 %8.2f p %8.1e) idn($modseq) saving(`"`tfcur'"', replace) flist(tflist)
 }
 }
 }
...
save Outputdata_overall_Dprime, replace

**Smile plot**
use Outputdata_overall_Dprime, clear
...
capture log using "E:\UK_BIOBANK_PROJECT\UKB_PAPER4B_LE8INFECTMRI_NODDI\OUTPUT\FIGURE5.smcl"

**********************************************************COGN VS. NODDI MEASURES*************************

use finaldata_unimputedFINAL,clear 


lowess zISOVF_mean  POORCOGN if sample_final==1 & zISOVF_mean<5 & zISOVF_mean>-5
graph save ISOVF_COGN.gph, replace

lowess zICVF_mean  POORCOGN if sample_final==1 & zICVF_mean<5 & zICVF_mean>-5
graph save ICVF_COGN.gph,replace


lowess zOD_mean  POORCOGN if sample_final==1 & zOD_mean<5 & zOD_mean>-5
graph save OD_COGN.gph,replace

graph matrix zISOVF_mean zICVF_mean zOD_mean if sample_final==1 & zISOVF_mean<5 & zISOVF_mean>-5 & zICVF_mean<5 & zICVF_mean>-5 & zOD_mean<5 & zOD_mean>-5
graph save NODDI_SCATTER.gph,replace


graph combine "ISOVF_COGN.gph" "ICVF_COGN.gph" "OD_COGN.gph" "NODDI_SCATTER.gph"
graph save NODDI_COGN.gph,replace

pwcorr zISOVF_mean zICVF_mean zOD_mean POORCOGN if sample_final==1 & zISOVF_mean<5 & zISOVF_mean>-5 & zICVF_mean<5 & zICVF_mean>-5 & zOD_mean<5 & zOD_mean>-5, sig

su zISOVF_mean zICVF_mean zOD_mean if sample_final==1 & zISOVF_mean<5 & zISOVF_mean>-5 & zICVF_mean<5 & zICVF_mean>-5 & zOD_mean<5 & zOD_mean>-5

*********BIVARIATE MODEL********

reg zISOVF_mean POORCOGN  if  sample_final==1 & zISOVF_mean<5 & zISOVF_mean>-5 

reg zICVF_mean POORCOGN if  sample_final==1 &  zICVF_mean<5 & zICVF_mean>-5 

reg zOD_mean POORCOGN  if  sample_final==1 & zOD_mean<5 & zOD_mean>-5 


********FULL MODEL*************

reg zISOVF_mean POORCOGN AGE SEX  NonWhite householdsize TIME_V0V2 LE8_TOTALSCORE AD_PGS invmillsMRIINF  if  sample_final==1 & zISOVF_mean<5 & zISOVF_mean>-5 & zICVF_mean<5 & zICVF_mean>-5 & zOD_mean<5 & zOD_mean>-5 

reg zICVF_mean POORCOGN AGE SEX  NonWhite householdsize TIME_V0V2 LE8_TOTALSCORE AD_PGS invmillsMRIINF if  sample_final==1 & zISOVF_mean<5 & zISOVF_mean>-5 & zICVF_mean<5 & zICVF_mean>-5 & zOD_mean<5 & zOD_mean>-5 

reg zOD_mean POORCOGN AGE SEX  NonWhite householdsize TIME_V0V2 LE8_TOTALSCORE AD_PGS invmillsMRIINF if  sample_final==1 & zISOVF_mean<5 & zISOVF_mean>-5 & zICVF_mean<5 & zICVF_mean>-5 & zOD_mean<5 & zOD_mean>-5 
...
*************************************OUTPUTS C AND D: TOTAL AND HOSPITAL-TREATED INFECTIONS SIGNIFICANT RESULTS: Q<0.05******************************************************

****BY LE8 TERTILE*****************

use Outputdata_overall_Cprime, clear

list command estimate parm LE8_TOTALSCOREtert if myqvallargervolumes<0.05
...
list command estimate parm AD_PGStert if myqvallargervolumes<0.05
...
capture log using "E:\UK_BIOBANK_PROJECT\UKB_PAPER4B_LE8INFECTMRI_NODDI\OUTPUT\FIGURES4fin.smcl",replace


****************************************************FIGURE S4: SMALLER SAMPLE**********************************************
...
merge n_eid using finaldata_unimputedFINAL
save finaldata_unimputedFINAL_INFECTIONS, replace
...
tab1 ts_13*yn if sample_final==1
...
su time_baseline if time_baseline>-25550 & infectionburdenhosp~=0 & sample_final==1, det
...
su time_baseline if time_baseline>-25550 & infectionburdennonhosp~=0 & sample_final==1,det
...
su time_baseline if time_baseline>-25550 & infectionburden~=0 & sample_final==1,det
...
capture log using "E:\UK_BIOBANK_PROJECT\UKB_PAPER4B_LE8INFECTMRI_NODDI\OUTPUT\FIGURE2SENS.smcl",replace



*********************************************SENSITIVITY ANALYSIS: LOG TRANSFORMED TRACTS, FIGURE 2**********************************************************
...
save finaldata_unimputedFINALSENS, replace

**foreach y1 of varlist zFA_* zMD_* {
**reg `y1' infectionburdentert AGE SEX  i.RACE_ETHN AD_PGS householdsize TIME_V0V2  invmillsMRIINF if sample_final==1
**}

capture drop LnISOVF_* LnICVF_* LnOD_*
foreach x of varlist ISOVF_* ICVF_* OD_* {
gen Ln`x'=ln(`x')	
}

capture drop zLnISOVF_* zLnICVF_* zLnOD_*
foreach x of varlist LnISOVF_* LnICVF_* LnOD_* {
...
global modseq=0
foreach X of var infectionburdentert {
foreach Y of var zLnISOVF_* zLnICVF_* zLnOD_* {
global modseq=$modseq+1
tempfile tfcur
parmby "regr `Y' `X'  AGE SEX  NonWhite AD_PGS householdsize TIME_V0V2  invmillsMRIINF if sample_final==1, beta", label command format(estimate min95 max95 %8.2f p %8.1e) idn($modseq) saving(`"`tfcur'"', replace) flist(tflist)
 }
...
save Outputdata_overall_BprimeSENS, replace

**Smile plot**
use Outputdata_overall_BprimeSENS, clear
